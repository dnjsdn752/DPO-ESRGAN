...
for i, (lr, hr) in enumerate(dataloader):
    ...
    pieapp_loss: torch.Tensor = piq.PieAPP(reduction='none', stride=clamp_sr.shape[2])(hr.detach(), clamp_sr) # Denormalize result passed through model to compare with original image -> pie results are all identical...
